...
%% for arch 3 8 1:  0.0395
%% for arch 3 12 1: 0.0450
%% for arch 3 20 1: 0.0490
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


function er=babyNN_1b(ppp,c)
  load('approximatemeifyoucan_b');
  n=size(ppp,2)-1;
for k = 1:15   
  % Initializing.
